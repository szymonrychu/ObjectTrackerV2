...
extern "C" {
JNIEXPORT jlong JNICALL Java_simple_as_fuck_objecttrackerv2_calibrator_Calibrator_newCalibratorNtv(JNIEnv* env, jobject\
		, jint x, jint y){
	CameraCalibrator*calibrator = new CameraCalibrator(x,y);
	return (jlong)calibrator;
}
JNIEXPORT void JNICALL Java_simple_as_fuck_objecttrackerv2_calibrator_Calibrator_delCalibratorNtv(JNIEnv* env, jobject\
...
JNIEXPORT jobjectArray JNICALL Java_simple_as_fuck_objecttrackerv2_calibrator_Calibrator_detectChessBoardNtv(JNIEnv* env, jobject\
...
JNIEXPORT void JNICALL Java_simple_as_fuck_objecttrackerv2_calibrator_Calibrator_addFrameToSetNtv(JNIEnv* env, jobject\
		,jlong calibratorAddr){
	if(calibratorAddr != 0){
		CameraCalibrator*calibrator = (CameraCalibrator*)calibratorAddr;
...
JNIEXPORT void JNICALL Java_simple_as_fuck_objecttrackerv2_calibrator_Calibrator_processFramesNtv(JNIEnv* env, jobject\
		,jlong calibratorAddr){
	if(calibratorAddr != 0){
		CameraCalibrator*calibrator = (CameraCalibrator*)calibratorAddr;
...
JNIEXPORT jobject JNICALL Java_simple_as_fuck_objecttrackerv2_calibrator_Calibrator_getCameraMatrixNtv(JNIEnv* env, jobject\
		,jlong calibratorAddr){
	if(calibratorAddr != 0){
		CameraCalibrator*calibrator = (CameraCalibrator*)calibratorAddr;
...
JNIEXPORT jobject JNICALL Java_simple_as_fuck_objecttrackerv2_calibrator_Calibrator_getDistortionCoefficientNtv(JNIEnv* env, jobject\
		,jlong calibratorAddr){
	if(calibratorAddr != 0){
		CameraCalibrator*calibrator = (CameraCalibrator*)calibratorAddr;
